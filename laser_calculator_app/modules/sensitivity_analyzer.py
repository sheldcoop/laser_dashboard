...
def render():
    ...
    with col_outputs:
        ...
        # --- NEW: RENDER THE BLUEPRINT FIRST ---
    ...
    with st.expander("Understanding the Scorecard", expanded=False):
        ...
        st.markdown("This gauge measures the **Fluence Ratio** (`Peak Fluence / Ablation Threshold`). A lower number is more efficient. The optimal **Green Zone is 0-7x**.")
